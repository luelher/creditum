<%@ Page language="c#" Codebehind="Error.aspx.cs" AutoEventWireup="false" Inherits="Creditum.PCOA.Error" %>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			...
			<asp:Label id="lblTitulo" style="Z-INDEX: 102; LEFT: 72px; POSITION: absolute; TOP: 24px" runat="server"
				Font-Size="X-Small" Width="144px" Height="56px" ForeColor="Red">Error</asp:Label>
		</form>
	</body>
</HTML>
