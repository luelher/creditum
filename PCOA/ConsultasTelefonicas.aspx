<%@ Page CodeBehind="ConsultasTelefonicas.aspx.cs" Language="c#" AutoEventWireup="false" Inherits="Creditum.PCOA.ConsultasTelefonicas" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN">
<HTML>
	<HEAD>
		<title>Creditum - Consultas Telefónicas</title>
										...
										<tr>
											...
											<td class="rightcolumn" vAlign="top">
												...
												<BLOCKQUOTE dir="ltr" style="MARGIN-RIGHT: 0px">
													<P><EM><STRONG>Paso1. </STRONG>Ingrese la cédula del cliente telefónico</EM>, y 
														luego haga click en ver cliente. Verifique los datos para asegurarse de que la 
														persona esta autorizada</P>
													<P>&nbsp;</P>
													<P></P>
													<P><asp:label id="lblCliente" runat="server" Font-Size="XX-Small">CEDULA</asp:label></P>
													<P><asp:textbox id="txtCedulaCliente" runat="server" Font-Size="XX-Small" Width="88px"></asp:textbox></P>
													<P>&nbsp;</P>
													<P><asp:button id="btnVerCliente" runat="server" Font-Size="XX-Small" CausesValidation="False"
															Text="Ver Cliente"></asp:button></P>
													<P>&nbsp;</P>
													<P></P>
													<P align="justify"><asp:label id="lblErrorCliente" runat="server" ForeColor="Red"></asp:label></P>
													<P align="justify"><asp:datagrid id="DataGridCliente" runat="server" Width="473px" Height="35px" PageSize="1" HorizontalAlign="Left"
															Visible="False" CellPadding="2" BorderStyle="None" BorderColor="Green" BorderWidth="100px">
													...
													<P>&nbsp;</P>
													<P>&nbsp;</P>
													<asp:image id="Image1" runat="server" ImageUrl="Home_files/H_Separador.gif" Width="480px" Height="8px"></asp:image>
													<P align="justify">
													<p align="justify"><EM><STRONG> </STRONG></EM>&nbsp;</p>
													<P align="justify"><EM><STRONG> </STRONG></EM>&nbsp;</P>
													<P align="justify"><EM><STRONG>Paso2. </STRONG>Ingrese la cédula</EM>, y luego haga 
														click en Ver detalles, para obtener la información de la persona (historial 
														crediticio).</P>
													...
													<P align="justify">&nbsp;</P>
													<P><asp:button id="btnDetalles" runat="server" Font-Size="XX-Small" Text="Ver detalles" Enabled="False"></asp:button></P>
													<a name="#btnDatosPersonales"></a>
													<P align="justify">&nbsp;</P>
													<P align="justify"><asp:label id="lblError" runat="server" ForeColor="Red"></asp:label></P>
													<P align="justify">
													...
													<P dir="ltr"><asp:datagrid id="DataGridDetalles" runat="server" Width="472px" Height="35px" PageSize="1" HorizontalAlign="Left"
