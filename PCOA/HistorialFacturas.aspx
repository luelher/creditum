<%@ Page language="c#" Codebehind="HistorialFacturas.aspx.cs" AutoEventWireup="false" Inherits="Creditum.PCOA.HistorialFacturas" %>
			...
			<P>
				<TABLE id="Table1" height="437" width="658" align="center" border="0">
					<TBODY>
						...
						<TR>
							<TD width="544" colSpan="2">&nbsp;<STRONG><FONT size="2">Ordenes de Facturación emitidas el 
										día:</FONT></STRONG></TD>
							<TD>
						...
						<TR>
							<TD colSpan="3">
								<P align="center"><FONT size="5">Historial&nbsp;de Órdenes de Facturación</FONT></P>
							</TD>
						</TR>
						<TR>
