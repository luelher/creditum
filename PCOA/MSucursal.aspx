<%@ Page language="c#" Codebehind="MSucursal.aspx.cs" AutoEventWireup="false" Inherits="Creditum.PCOA.MSucursal" %>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			...
			<asp:RegularExpressionValidator id="RegularExpressionValidatorEmail" style="Z-INDEX: 126; LEFT: 272px; POSITION: absolute; TOP: 392px"
				runat="server" ControlToValidate="txtEmail" ErrorMessage="Email inválido" ValidationExpression="\w+([-+.]\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"
			...
			<asp:Label id="lblUbicacion" style="Z-INDEX: 114; LEFT: 16px; POSITION: absolute; TOP: 200px"
			...
			<asp:Label id="lblNit" style="Z-INDEX: 113; LEFT: 48px; POSITION: absolute; TOP: 168px" runat="server"
			...
			<asp:Label id="lblRif" style="Z-INDEX: 112; LEFT: 48px; POSITION: absolute; TOP: 136px" runat="server"
				Font-Size="X-Small">Rif</asp:Label>
			<asp:TextBox id="txtRif" style="Z-INDEX: 110; LEFT: 80px; POSITION: absolute; TOP: 136px" runat="server"
			...
			<asp:TextBox id="txtNombre" style="Z-INDEX: 111; LEFT: 80px; POSITION: absolute; TOP: 104px"
				runat="server" Width="184px"></asp:TextBox>
			<asp:Button id="btnAceptar" style="Z-INDEX: 115; LEFT: 136px; POSITION: absolute; TOP: 424px"
				runat="server" Font-Size="XX-Small" Text="Guardar"></asp:Button>
			<asp:RequiredFieldValidator id="RequiredFieldValidatorNombre" style="Z-INDEX: 116; LEFT: 272px; POSITION: absolute; TOP: 112px"
			...
			<asp:ValidationSummary id="ValidationSummaryCC" style="Z-INDEX: 117; LEFT: 16px; POSITION: absolute; TOP: 456px"
				runat="server" HeaderText="Errores Encontrados"></asp:ValidationSummary>
			<asp:TextBox id="txtCC" style="Z-INDEX: 127; LEFT: 80px; POSITION: absolute; TOP: 72px" runat="server"
				Width="240px" Enabled="False" ReadOnly="True">---------NINGUNA---------</asp:TextBox>
		</form>
	</body>
</HTML>
