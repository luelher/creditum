<%@ Page CodeBehind="Contactanos.aspx.cs" Language="c#" AutoEventWireup="false" Inherits="Creditum.Via_Email" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN">
<HTML>
	<HEAD>
		<title>Creditum - Contáctanos</title> 
											...
											<td class="rightcolumn" vAlign="top">
												...
												<BLOCKQUOTE dir="ltr" style="MARGIN-RIGHT: 0px">
													<P align="justify"><EM><STRONG>Informadora de&nbsp;Crédito en Línea</STRONG></EM>, 
														le permite comunicarse con nuestros operadores y técnicos para aclarar todas 
														sus dudas respecto a nuestro servicio y a nuestro sistema.</P>
													<P align="justify">&nbsp;</P>
													<P align="justify">Si tiene alguna duda respecto a nuestros servicios, si necesita 
														ayuda o simplemente desea enviarnos alguna sugerencia, por favor comuníquese 
														con nosotros que con gusto le responderemos.</P>
													<P align="justify">&nbsp;</P>
													<UL>
														<LI>
															<DIV align="justify">
																<asp:hyperlink id="lnkMail" runat="server" NavigateUrl="via_telefonica.aspx" Font-Size="X-Small"
																	ForeColor="Green">Contáctanos Vía Telefónica</asp:hyperlink></DIV>
														</LI>
													</UL>
													<P align="justify">&nbsp;</P>
													<UL>
														<LI>
															<DIV align="justify">
																<asp:hyperlink id="Hyperlink1" runat="server" NavigateUrl="via_email.aspx" ForeColor="Green" Font-Size="X-Small">Contáctanos Vía Correo Electrónico (E-mail)</asp:hyperlink></DIV>
														</LI>
													</UL>
													<P align="justify">&nbsp;</P>
												</BLOCKQUOTE>
