<%@ Page CodeBehind="ModificarUsuarioC.aspx.cs" Language="c#" AutoEventWireup="false" Inherits="Creditum.PCOA.ModifcarUsuarioC" %>
									...
									<table cellSpacing="0" cellPadding="0" width="100%" border="0">
										<tr>
											...
											<td class="rightcolumn" vAlign="top">
												...
												<P>&nbsp;</P>
												<P><STRONG><EM>Paso1:</EM></STRONG> &nbsp;&nbsp;Seleccione al usuario a Modificar.</P>
												<P>&nbsp;</P>
												<P>
													<asp:Label id="Label4" runat="server" Font-Size="XX-Small">USUARIO</asp:Label></P>
												<P>
													<asp:DropDownList id="DropDownListUsuario" runat="server" Width="328px" AutoPostBack="True"></asp:DropDownList></P>
												<P align="justify">&nbsp;</P>
												<P align="justify">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
