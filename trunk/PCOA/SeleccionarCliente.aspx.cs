...
{
	/// <summary>
	/// Descripción breve de SeleccionarCliente.
	/// </summary>
	public class SeleccionarCliente : System.Web.UI.Page
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			string scriptConfirmar = @"return confirm('Esta seguro que desea generar la orden de facturación del cliente?');";
		...
		{
			Response.Redirect(@"FacturaCliente.aspx?id=" + DropDownListCasa.SelectedValue);		
		}
