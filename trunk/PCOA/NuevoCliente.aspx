<%@ Page CodeBehind="NuevoCliente.aspx.cs" Language="c#" AutoEventWireup="false" Inherits="Creditum.PCOA.NuevoCliente" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN">
<HTML>
	<HEAD>
		<title>Creditum - Nuevo Cliente</title>
									...
									<table cellSpacing="0" cellPadding="0" width="100%" border="0">
										<tr>
											...
											<td class="rightcolumn" vAlign="top">
												...
												<P>&nbsp;</P>
												<P><STRONG><EM>Paso1:</EM></STRONG> Seleccione la Casa Comercial a la que pertenece 
													el nuevo cliente. Si no está asociado a una Casa Comercial, seleccione NINGUNA. 
													Si la Casa Comercial no está registrada presione
													<asp:LinkButton id="lnkbtnNuevaCasa" runat="server" Font-Size="X-Small" ToolTip="Nueva Casa Comercial"
														CausesValidation="False">aquí</asp:LinkButton>.</P>
												<P>&nbsp;</P>
												<P>
													<asp:Label id="lblCasa" runat="server">Casa Comercial</asp:Label></P>
												<P align="justify">
													<asp:DropDownList id="DropDownListCasa" runat="server" Width="328px" AutoPostBack="True">
														<asp:ListItem Value="0">NINGUNA</asp:ListItem>
													</asp:DropDownList>&nbsp;
													<asp:Button id="btnRefrescarCC" runat="server" Font-Size="XX-Small" Text="Refrescar" CausesValidation="False"></asp:Button></P>
												<P align="justify">&nbsp;</P>
												<P align="justify"><STRONG><EM>Paso2:</EM></STRONG> Seleccione la Sucursal a la que 
													pertenece el nuevo cliente. Si la sucursal no está registrada presione
													<asp:LinkButton id="lnkbtnNuevaSucursal" runat="server" Font-Size="X-Small" ToolTip="Nueva Sucursal"
														CausesValidation="False">aquí</asp:LinkButton>.</P>
												<P align="justify">&nbsp;</P>
												<P align="justify">
													<asp:Label id="lblSucursal" runat="server">Sucursal</asp:Label></P>
												<P>
													<asp:DropDownList id="DropDownListSucursal" runat="server" Width="222px"></asp:DropDownList>&nbsp;
													<asp:Button id="btnRefrescarSuc" runat="server" Font-Size="XX-Small" Text="Refrescar" CausesValidation="False"></asp:Button></P>
												<P>&nbsp;</P>
												<P>
													<asp:image id="Image1" runat="server" ImageUrl="Home_files/H_Separador.gif" Height="8px" Width="480px"></asp:image></P>
												<P>&nbsp;</P>
												<P><STRONG><EM>Paso3:</EM></STRONG> Ingrese los datos personales del&nbsp;usuario 
													administrador del nuevo cliente</P>
												<P>&nbsp;</P>
												<P>
												...
												<P>&nbsp;</P>
												<P>
													<asp:image id="Image2" runat="server" ImageUrl="Home_files/H_Separador.gif" Width="480px" Height="8px"></asp:image></P>
												<P>&nbsp;</P>
												<P><STRONG><EM>Paso4:</EM></STRONG> Configuración del nuevo cliente</P>
												<P>&nbsp;</P>
												<P>
													<asp:Label id="Label4" runat="server" Font-Size="XX-Small">PORCENTAJE DE DESCUENTO POR CONSULTA</asp:Label></P>
												<P></P>
												<P>
													<asp:DropDownList id="DropDownListDesc" runat="server" Width="72px"></asp:DropDownList>
												<P>
												<P>
