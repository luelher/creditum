<%@ Page CodeBehind="EliminarCliente.aspx.cs" Language="c#" AutoEventWireup="false" Inherits="Creditum.PCOA.EliminarCliente" %>
									...
									<table cellSpacing="0" cellPadding="0" width="100%" border="0">
										<tr>
											...
											<td class="rightcolumn" vAlign="top">
												...
												<P>&nbsp;</P>
												<P><STRONG><EM>Paso1:</EM></STRONG> Seleccione&nbsp;el cliente&nbsp;a Eliminar y 
													luego presione Eliminar para remover al cliente del sistema</P>
												<P>&nbsp;</P>
												<P>
													Cliente</P>
												<P align="justify">
												...
												<P>
												<P>
													<asp:Button id="btnAceptar" runat="server" Text="Eliminar" Font-Size="XX-Small"></asp:Button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</P>
												<P>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</P>
												<P align="left">&nbsp;</P>
											</td>
										</tr>
