<%@ Page CodeBehind="ModificarUsuario.aspx.cs" Language="c#" AutoEventWireup="false" Inherits="Creditum.PCOA.ModifcarUsuario" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN">
<HTML>
	<HEAD>
		<title>Creditum - Modificar Usuario</title>
									...
									<table cellSpacing="0" cellPadding="0" width="100%" border="0">
										<tr>
											...
											<td class="rightcolumn" vAlign="top">
												...
												<P>&nbsp;</P>
												<P><STRONG><EM>Paso1:</EM></STRONG> &nbsp;Ingrese la Cédula del usuario a modificar 
													y presione en Ver detalles.</P>
												<P>
												...
												<P>
													<asp:Label id="Label4" runat="server" Font-Size="XX-Small">CÉDULA</asp:Label></P>
												<P></P>
												<P>
													<asp:textbox id="txtCedulaBuscar" runat="server" Width="88px" Font-Size="XX-Small"></asp:textbox>
													<asp:RangeValidator id="RangeValidatorCIBuscar" runat="server" Font-Size="X-Small" ErrorMessage="Cédula Inválida"
														ControlToValidate="txtCedulaBuscar" MaximumValue="100000000" MinimumValue="1000000" Type="Integer"
														EnableClientScript="False">*</asp:RangeValidator>
													<asp:requiredfieldvalidator id="RequiredfieldvalidatorCIBuscar" runat="server" Width="23px" Font-Size="X-Small"
														ErrorMessage="Especifique una Cédula" ControlToValidate="txtCedulaBuscar" EnableClientScript="False">*</asp:requiredfieldvalidator></P>
												<P align="justify">&nbsp;</P>
												<P align="justify">
													<asp:Button id="btnDetalles" runat="server" Font-Size="XX-Small" Text="Ver detalles"></asp:Button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												...
												<P><STRONG><EM>
															<asp:DataGrid id="DataGridDatosPersonales" runat="server" Width="408px" Height="35px" PageSize="1"
																HorizontalAlign="Left" Visible="False" CellPadding="2" BorderStyle="None" BorderColor="Green">
												...
												<P>&nbsp;</P>
												<P><STRONG><EM>Paso2:</EM></STRONG> Modifique&nbsp;el nivel de 
													accesibilidad&nbsp;del usuario y presione Aceptar. Si desea establecer la 
													contraseña al valor predeterminado presione Reestablecer Password</P>
												<P>&nbsp;</P>
												<P>
												...
												<P>
													<asp:DropDownList id="DropDownListNivel" runat="server" Width="232px">
														<asp:ListItem Value="1">OPERADOR ADMINISTRADOR</asp:ListItem>
														<asp:ListItem Value="2">OPERADOR</asp:ListItem>
														<asp:ListItem Value="4">CONSULTOR ADMINISTRADOR</asp:ListItem>
													</asp:DropDownList></P>
												<P>&nbsp;</P>
												<P>
													<asp:Button id="btnAceptar" runat="server" Text="Aceptar" Font-Size="XX-Small" Enabled="False"></asp:Button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
													<asp:Button id="btnPwd" runat="server" Font-Size="XX-Small" Text="ReestablecerPassword" Enabled="False"></asp:Button></P>
												<P>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</P>
												<P align="left">&nbsp;</P>
											</td>
										</tr>
