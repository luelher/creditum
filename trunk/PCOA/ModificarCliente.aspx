<%@ Page CodeBehind="ModificarCliente.aspx.cs" Language="c#" AutoEventWireup="false" Inherits="Creditum.PCOA.ModificarCliente" %>
									...
									<table cellSpacing="0" cellPadding="0" width="100%" border="0">
										<tr>
											...
											<td class="rightcolumn" vAlign="top">
												...
												<P>&nbsp;</P>
												<P><STRONG><EM>Paso1:</EM></STRONG> Seleccione&nbsp;el cliente&nbsp;a modificar</P>
												<P>&nbsp;</P>
												<P>
													Cliente</P>
												<P align="justify">
													<asp:DropDownList id="DropDownListCasa" runat="server" Width="328px" AutoPostBack="True"></asp:DropDownList>
													<asp:Button id="btnRefrescar" runat="server" CausesValidation="False" Font-Size="XX-Small" Text="Refrescar"></asp:Button></P>
												<P align="justify">&nbsp;</P>
												<P align="justify"><STRONG>Información de la&nbsp;Casa 
														Comercial&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
														<asp:LinkButton id="lnkbtnModificarCC" runat="server" Font-Size="XX-Small" Visible="False" CausesValidation="False">Modificar</asp:LinkButton></STRONG></P>
												<P align="justify">
												...
												<P align="justify"><STRONG>Detalles de la Sucursal&nbsp; 
														(Cliente)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
														<asp:LinkButton id="lnkbtnModificarSuc" runat="server" Font-Size="XX-Small" Visible="False" CausesValidation="False">Modificar</asp:LinkButton></P>
												</STRONG>
												<P align="justify">
												...
												<P>&nbsp;</P>
												<P><STRONG><EM>Paso2:</EM></STRONG> Asigne&nbsp;el nuevos valor de 
													descuento&nbsp;para el cliente y luego presione Aceptar</P>
												<P>&nbsp;</P>
												<P>
												...
												<P>
												<P>
													<asp:Button id="btnAceptar" runat="server" Text="Aceptar" Font-Size="XX-Small"></asp:Button></P>
												<P>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</P>
												<P align="left">&nbsp;</P>
											</td>
										</tr>
