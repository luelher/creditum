<%@ Page language="c#" Codebehind="MCasaComercial.aspx.cs" AutoEventWireup="false" Inherits="Creditum.PCOA.MCasaComercial" %>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			...
			<asp:Label id="lblTitulo" style="Z-INDEX: 102; LEFT: 72px; POSITION: absolute; TOP: 24px" runat="server"
				Font-Size="X-Small">Modificar Casa Comercial</asp:Label>
