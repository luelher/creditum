<%@ Page CodeBehind="EliminarUsuario.aspx.cs" Language="c#" AutoEventWireup="false" Inherits="Creditum.PCOA.EliminarUsuario" %>
									...
									<table cellSpacing="0" cellPadding="0" width="100%" border="0">
										<tr>
											...
											<td class="rightcolumn" vAlign="top">
												...
												<P>&nbsp;</P>
												<P><STRONG><EM>Instrucciones:</EM></STRONG> &nbsp;Ingrese la Cédula del usuario 
													a&nbsp;eliminar y presione en Ver detalles. Luego, verifique los datos del 
													usuario y presione Eliminar para remover el usuario del sistema.</P>
												<P>
