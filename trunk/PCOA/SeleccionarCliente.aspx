<%@ Page CodeBehind="SeleccionarCliente.aspx.cs" Language="c#" AutoEventWireup="false" Inherits="Creditum.PCOA.SeleccionarCliente" %>
									...
									<table cellSpacing="0" cellPadding="0" width="100%" border="0">
										<tr>
											...
											<td class="rightcolumn" vAlign="top">
												...
												<H1>
													Seleccionar&nbsp;Cliente a Facturar</H1>
												<P>&nbsp;</P>
												...
												<P>&nbsp;</P>
												<P><STRONG><EM>Paso1:</EM></STRONG> Seleccione&nbsp;el cliente&nbsp;a facturar. 
													Luego presione Facturar para generar la orden de facturación del cliente 
													seleccionado</P>
												<P>&nbsp;</P>
												<P>
													Cliente</P>
												...
												<P>
												<P>
													<asp:Button id="btnAceptar" runat="server" Text="Facturar" Font-Size="XX-Small"></asp:Button></P>
												<P>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</P>
												<P align="left">&nbsp;</P>
											</td>
										</tr>
