<%@ Page CodeBehind="Via_Email.aspx.cs" Language="c#" AutoEventWireup="false" Inherits="Creditum.Info.Contactanos" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN">
<HTML>
	<HEAD>
		<title>Creditum - Contáctanos Vía Email</title>
											...
											<td class="rightcolumn" vAlign="top">
												...
												<BLOCKQUOTE dir="ltr" style="MARGIN-RIGHT: 0px">
													...
													<P align="justify">Para enviarnos un correo electrónico pulsa
														<asp:hyperlink id="lnkMail" runat="server" NavigateUrl="enviar_email.aspx" Font-Size="X-Small"
													...
													<P align="justify">&nbsp;</P>
													<P align="justify">Para enviarnos un correo electrónico pulsa
														<asp:hyperlink id="lnkMail2" runat="server" NavigateUrl="enviar_email.aspx" Font-Size="X-Small"
															ForeColor="Green">aquí</asp:hyperlink></P>
												</BLOCKQUOTE>
												<P align="justify">&nbsp;</P>
