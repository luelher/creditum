...
mainMenuItem("home_hnavbar_b4",".gif",43,117,"contactanos.aspx","","CONTACTANOS",2,2,"home_hnavbar_plain");
mainMenuItem("home_hnavbar_b5",".gif",43,117,"links.aspx","","LINKS",2,2,"home_hnavbar_plain");
mainMenuItem("home_hnavbar_b6",".gif",43,117,"ayuda.aspx","","AYUDA",2,2,"home_hnavbar_plain");
endMainMenu("",0,0);
...
submenuItem("RESPORTE DE USUARIOS","../perfilusuarios.aspx","","home_hnavbar_plain");
