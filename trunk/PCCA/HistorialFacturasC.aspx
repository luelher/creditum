<%@ Page language="c#" Codebehind="HistorialFacturasC.aspx.cs" AutoEventWireup="false" Inherits="Creditum.PCCA.HistorialFacturasC" %>
...
-->
	...
	<body>
		<form id="Form1" method="post" runat="server">
			...
			<P>
				<TABLE id="Table1" height="437" width="658" align="center" border="0">
					<TBODY>
						...
						<TR>
							<TD width="544" colSpan="2">&nbsp;<STRONG><FONT size="2"> Facturación emitida el día:</FONT></STRONG></TD>
							<TD>
								<P align="center">&nbsp;<FONT size="2"><STRONG>Fecha de Emisión del Historial:</STRONG></FONT></P>
							</TD>
						</TR>
						<TR>
							<TD width="544" colSpan="2"><STRONG><FONT size="2">&nbsp;</FONT></STRONG>
								<asp:label id="lblFHistorial" runat="server"></asp:label></TD>
							<TD>
								<P align="center">&nbsp;
						...
						<TR>
							<TD colSpan="3"><FONT size="2"><STRONG>Consulta Válida: </STRONG>
									<asp:label id="lblValida" runat="server"></asp:label>&nbsp;<STRONG>&nbsp;Consulta 
										Fallida: </STRONG>
									<asp:label id="lblFallida" runat="server"></asp:label></FONT></TD>
						</TR>
						<TR>
							<TD colSpan="3">
								<P align="center"><FONT size="5"> Historial&nbsp;de Facturación</FONT></P>
							</TD>
						</TR>
						<TR>
						...
						<TR>
							<TD width="544" colSpan="2">&nbsp;<STRONG> Listado de Facturas</STRONG></TD>
							<TD width="254">&nbsp;</TD>
						</TR>
						<TR>
							<TD colSpan="3">&nbsp;
			...
			<TR>
				<TD>&nbsp;
					<asp:hyperlink id="lnkPC" runat="server" ForeColor="Green" NavigateUrl="panelcontrolCA.aspx" Font-Size="XX-Small">Panel de Control</asp:hyperlink></TD>
				<TD width="422"></TD>
				<TD>
					<P align="right">&nbsp;
