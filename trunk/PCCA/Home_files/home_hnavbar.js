...
mainMenuItem("home_hnavbar_b2",".gif",43,117,"../info/quienes_somos.aspx","","¿QUIENES SOMOS?",2,2,"home_hnavbar_plain");
mainMenuItem("home_hnavbar_b3",".gif",43,117,"javascript:;","","SERVICIOS",2,2,"home_hnavbar_plain");
mainMenuItem("home_hnavbar_b4",".gif",43,117,"../info/contactanos.aspx","","CONTACTANOS",2,2,"home_hnavbar_plain");
mainMenuItem("home_hnavbar_b5",".gif",43,117,"../info/links.aspx","","LINKS",2,2,"home_hnavbar_plain");
mainMenuItem("home_hnavbar_b6",".gif",43,117,"../info/ayuda.aspx","","AYUDA",2,2,"home_hnavbar_plain");
endMainMenu("",0,0);
...
submenuItem("VIA TELEFONICA","../info/via_telefonica.aspx","","home_hnavbar_plain");
submenuItem("VIA EMAIL","../info/via_email.aspx","","home_hnavbar_plain");
endSubmenu("home_hnavbar_b4");

startSubmenu("home_hnavbar_b3_3","home_hnavbar_menu",146);
submenuItem("FACTURA","SeleccionarMes.aspx","","home_hnavbar_plain");
submenuItem("REPORTE DE USUARIOS","../perfilusuarios.aspx","","home_hnavbar_plain");
endSubmenu("home_hnavbar_b3_3");

startSubmenu("home_hnavbar_b3_2","home_hnavbar_menu",150);
submenuItem("INFORMACION CREDITICIA","../consultascreditos.aspx","","home_hnavbar_plain");
submenuItem("ESTADO DE CUENTA","../EstadoCuenta.aspx","","home_hnavbar_plain");
endSubmenu("home_hnavbar_b3_2");

startSubmenu("home_hnavbar_b3","home_hnavbar_menu",212);
submenuItem("PANEL DE CONTROL","panelcontrolca.aspx","","home_hnavbar_plain");
...
submenuItem("CAMBIO DE PASSWORD","../cambiopwd.aspx","","home_hnavbar_plain");
