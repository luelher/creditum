<%@ Page CodeBehind="PanelControlCA.aspx.cs" Language="c#" AutoEventWireup="false" Inherits="Creditum.PCCA.PanelControlCA" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN">
<HTML>
	<HEAD>
		<title>Creditum - Panel de Control de Consultores Administradores</title>
									...
									<table cellSpacing="0" cellPadding="0" width="100%" border="0">
										<tr>
											...
											<td class="rightcolumn" vAlign="top">
												...
												<H1>Panel de Control de&nbsp;Consultores Administradores</H1>
												<P>&nbsp;</P>
															...
															<UL>
																<UL>
																	<UL>
																		<LI>
																			<DIV align="justify">
																				<asp:hyperlink id="lnkNuevoUsuario" runat="server" NavigateUrl="NuevoUsuarioC.aspx">Nuevo Usuario</asp:hyperlink></DIV>
																		<LI>
																			<DIV align="justify">
																				<asp:hyperlink id="lnkModificarUsuario" runat="server" NavigateUrl="ModificarUsuarioC.aspx">Modificar Usuario</asp:hyperlink></DIV>
																		<LI>
																			<DIV align="justify">
																				<asp:hyperlink id="lnkEliminarUsuario" runat="server" NavigateUrl="EliminarUsuarioC.aspx">Eliminar Usuario</asp:hyperlink></DIV>
																		<LI>
																			<DIV align="justify">
												...
												<BLOCKQUOTE dir="ltr" style="MARGIN-RIGHT: 0px"> <BLOCKQUOTE dir="ltr" style="MARGIN-RIGHT: 0px">
														<P align="justify"><STRONG><EM>Consultas</EM></STRONG></P>
														<UL>
															<UL>
																<LI>
																	<DIV align="justify">
														...
														<UL>
															<UL>
																...
																<LI>
																	<DIV align="justify">
																		<asp:hyperlink id="Hyperlink5" runat="server" NavigateUrl="SeleccionarMes.aspx">Historial de Facturación por mes</asp:hyperlink></DIV>
																</LI>
															</UL>
														</UL>
														<EM><STRONG>
