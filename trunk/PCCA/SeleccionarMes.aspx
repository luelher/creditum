<%@ Page CodeBehind="SeleccionarMes.aspx.cs" Language="c#" AutoEventWireup="false" Inherits="Creditum.PCCA.SeleccionarMes" %>
									...
									<table cellSpacing="0" cellPadding="0" width="100%" border="0">
										<tr>
											...
											<td class="rightcolumn" vAlign="top">
												...
												<H1>
													Seleccionar&nbsp;la Fecha de Emisión de la Orden de Facturación</H1>
												<P>&nbsp;</P>
												...
												<P>&nbsp;</P>
												<P><STRONG><EM>Paso1:</EM></STRONG> Seleccione&nbsp;la&nbsp;fecha de emisión. Luego 
													presione&nbsp;Ver Facturas&nbsp;para generar&nbsp;el historial&nbsp;de 
													facturación correspondiente a la fecha seleccionada</P>
												<P>&nbsp;</P>
												<P><STRONG>Fecha de Emisión</STRONG></P>
												<P><STRONG></STRONG>&nbsp;</P>
												<P align="justify">MES:
													<asp:DropDownList id="DropDownListMes" runat="server" Width="128px">
												...
												<P align="justify">&nbsp;</P>
												<P align="justify">AÑO:
													<asp:DropDownList id="DropDownListAno" runat="server" Width="96px"></asp:DropDownList></P>
												<P>&nbsp;</P>
												<P>
												...
												<P>
												<P>
													<asp:Button id="btnAceptar" runat="server" Text="Ver Factura" Font-Size="XX-Small"></asp:Button></P>
												<P>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</P>
												<P align="left">&nbsp;</P>
											</td>
										</tr>
