<%@ Page CodeBehind="Home.aspx.cs" Language="c#" AutoEventWireup="false" Inherits="Creditum.Home" %>
									...
									<table cellSpacing="0" cellPadding="0" width="100%" border="0">
										<tr>
											...
											<td class="rightcolumn" vAlign="top">
												...
												<H1>Informadora de Crédito en Línea</H1>
												<P>&nbsp;</P>
												<BLOCKQUOTE dir="ltr" style="MARGIN-RIGHT: 0px">
													<p align="justify"><EM><STRONG>Informadora de Crédito en Línea</STRONG></EM>, le 
														permite proteger sus intereses al momento de realizar una transacción 
														crediticia de cualquier tipo.</p>
												</BLOCKQUOTE>
												<P align="justify">&nbsp;</P>
												<P align="justify">Consulte nuestra gran base de datos con información crediticia, 
													registros y experiencia de clientes pertenecientes a las casas comerciales más 
													importantes...</P>
												<P>&nbsp;</P>
												<H2>ESTAMOS EN LÍNEA LAS 24 HORAS DEL DÍA.</H2>
												<P>&nbsp;</P>
												<P dir="ltr" style="MARGIN-RIGHT: 0px" align="left">Disfruta de nuestro período de 
													prueba, donde tendrás acceso a la información&nbsp;de manera gratuita por 3 
													días,&nbsp;evalúa nuestro servicio y escríbenos dándonos tu opinión. Para 
													enviarnos un correo electrónico pulsa
													<asp:hyperlink id="lnkEmail" runat="server" ForeColor="Green" NavigateUrl="Info\Enviar_Email.aspx"
												...
												<P>&nbsp;</P>
												<P align="left">Entra&nbsp;a nuestro sistema y realiza tus consultas de información 
													crediticia.</P>
												<P>&nbsp;</P>
