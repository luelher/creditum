<%@ Page CodeBehind="EstadoCuenta.aspx.cs" Language="c#" AutoEventWireup="false" Inherits="Creditum.EstadoCuenta" %>
		...
		<form id="PerfilUsuarios" method="post" runat="server">
			<table height="437" width="658" align="center" border="0">
				...
				<tr>
					...
					<td>
						<P align="center">&nbsp;<FONT size="2"><STRONG>Fecha de Emisión del Reporte:</STRONG></FONT></P>
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td colSpan="3">
						<p align="center"><font size="5">Consultas del Mes en Curso</font></p>
					</td>
				</tr>
				<TR>
				...
				<tr>
					<td width="544" colSpan="2">&nbsp;<STRONG> Consultas Válidas:
							<asp:label id="lblV" runat="server" ForeColor="SeaGreen"></asp:label></STRONG></td>
					<td width="254">&nbsp;</td>
				</tr>
				<tr>
					<td colSpan="3">&nbsp;
						<DIV align="center">
							<asp:datagrid id="DataGridV" runat="server" Height="35px" PageSize="1" HorizontalAlign="Left"
				...
				<TR>
					<TD colSpan="3"><STRONG>Consultas Fallidas:
							<asp:label id="lblF" runat="server" ForeColor="Red"></asp:label></STRONG></TD>
				</TR>
				<TR>
					<TD colSpan="3">
						<P>&nbsp;</P>
						<asp:datagrid id="DatagridF" runat="server" Width="691px" BorderStyle="None" CellPadding="2" Visible="False"
							HorizontalAlign="Left" PageSize="1" GridLines="None" Height="35px">
							<AlternatingItemStyle BackColor="#C0FFC0"></AlternatingItemStyle>
							<ItemStyle Font-Size="XX-Small"></ItemStyle>
							<HeaderStyle Font-Size="XX-Small" Font-Bold="True" HorizontalAlign="Left" BorderWidth="16px"
								ForeColor="Black" BorderStyle="Double" BorderColor="#404040" VerticalAlign="Middle" BackColor="SeaGreen"></HeaderStyle>
