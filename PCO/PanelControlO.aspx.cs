...
namespace Creditum.PCO
{
	/// <summary>
	/// Descripción breve de PanelControlO.
	/// </summary>
	public class PanelControlO : System.Web.UI.Page
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			if (usr != null)
			{
				if (usr.PermitirAcceso(Convert.ToByte(Usuario.Nivel_Usuario.OPERADOR)))
