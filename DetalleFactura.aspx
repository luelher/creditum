<%@ Page CodeBehind="DetalleFactura.aspx.cs" Language="c#" AutoEventWireup="false" Inherits="Creditum.DetalleFactura" %>
	...
	<body>
		<form id="PerfilUsuarios" method="post" runat="server">
			<table height="437" width="658" align="center" border="0">
				...
				<tr>
					<td colSpan="3">
						<p align="center"><font size="5">Detalle de Factura Nro
								<asp:label id="lblFactura" runat="server" Font-Size="Medium"></asp:label></font></p>
					</td>
				</tr>
				<TR>
				...
				<tr>
					<td width="544" colSpan="2">&nbsp;<STRONG> Consultas Válidas</STRONG></td>
					<td width="254">&nbsp;</td>
				</tr>
				<tr>
					<td colSpan="3">&nbsp;
				...
				<TR>
					<TD colSpan="3"><STRONG>Consultas Fallidas</STRONG></TD>
				</TR>
				<TR>
					<TD colSpan="3">
						<P>&nbsp;</P>
